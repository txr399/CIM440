var questions = ["Name the main reason a person might wake up to at 2 in the morning."];
var options = ["1) bathroom 2) eat 3) bad dream 4) heard a noise","1) pacific 2) eastern 3) indian 4) atlantic"];
var answers = [1,3];
